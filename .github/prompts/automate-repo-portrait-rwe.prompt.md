...
- Keep code, paths, globs, identifiers, and Envelope field names in English exactly as written.
- Do NOT use Markdown headings (#, ##, ###) and do NOT use bold text.
...
5) Build a roadmap as RWE technical envelopes.
