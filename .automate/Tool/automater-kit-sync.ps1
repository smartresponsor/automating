...
param(
  ...
  [string]$LockPath    = $(if ($env:AUTOMATER_KIT_LOCK_PATH) { $env:AUTOMATER_KIT_LOCK_PATH } else { ".automater/automater-kit.lock.json" }),
...
$backupRoot = Join-Path ".automater/backup" $tag
